 
{
 TAXONOMY : {
      ...
      , IT        : [   'Support via Desktop Sharing Software (for example Teamviewer)'
                    ...
                    ,   'User Management (in general)'
                    ,   'Printer( - Support / Maintenace / Leasing Logfiles FollowMePrint...)'
                    ...
                    ,   'Database'
                    ,   'File Destruction (see also Volume and File Destruction)'
                    ,   'Archiving of electronic Receipt of Delivery'
                    ]
      , MOBILE    : [   'Smartphone '
                    ,   'Mobile Device Management (for example' : 'AirWatch)'
                    ]
